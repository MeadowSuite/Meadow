[![TeamCity Build Status](https://teamcity.meadowsuite.com/app/rest/builds/buildType:(id:Meadow_MeadowSuiteTest)/statusIcon)](https://teamcity.meadowsuite.com/viewType.html?buildTypeId=Meadow_MeadowSuiteTest&guest=1) 
