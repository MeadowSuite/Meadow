...
// Taken from https://github.com/Microsoft/referencesource/blob/90b323fe52bec428fe4bd5f007e9ead6b265d553/mscorlib/system/security/cryptography/ripemd160managed.cs
...
namespace System.Security.Cryptography
{
    ...
    {
        // Unofficial edit: Added hash size for external referencing.
        ...
        private void HashData(byte[] partIn, int ibStart, int cbSize)
        {
            int bufferLen;
            ...
            Span<uint> stateMD160 = _stateMD160;

            Span<byte> buffer = _buffer;

            Span<uint> blockDWords = _blockDWords;
