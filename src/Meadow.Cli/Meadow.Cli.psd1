...
@{
    ...
    CompanyName = 'MeadowSuite'
    
    # Copyright statement for this module
    Copyright = '(c) MeadowSuite. All rights reserved.'
...
#>
    ...
    PrivateData = @{
        ...
        PSData = @{
            ...
            LicenseUri = 'https://github.com/MeadowSuite/Meadow/blob/master/LICENSE'
    
            # A URL to the main website for this project.
            ProjectUri = 'https://github.com/MeadowSuite/Meadow'
    
            # A URL to an icon representing this module.
            # IconUri = ''
    
            # ReleaseNotes of this module
            ReleaseNotes = 'https://github.com/MeadowSuite/Meadow'
    ...
    HelpInfoURI = 'https://github.com/MeadowSuite/Meadow'
